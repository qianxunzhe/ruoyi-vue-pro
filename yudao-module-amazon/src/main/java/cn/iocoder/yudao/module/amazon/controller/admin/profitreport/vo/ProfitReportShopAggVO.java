 ...
 * 店铺维度聚合结果 VO
 */
@Schema(description = "管理后台 - 店铺维度聚合结果 VO")
@Data
public class ProfitReportShopAggVO {
    ...
    @Schema(description = "SKU数量", example = "100")
    @ExcelProperty("SKU数量")
    ...
    @Schema(description = "退款金额", example = "10000.00")
    @ExcelProperty("退款金额")
    private BigDecimal totalSalesRefunds;
    
    @Schema(description = "退货退款", example = "12000.00")
    @ExcelProperty("退货退款")
    private BigDecimal totalRefunds;
    
    @Schema(description = "销售成本", example = "100000.00")
    @ExcelProperty("销售成本")
    private BigDecimal cgPriceTotal;
    
    @Schema(description = "头程运费", example = "20000.00")
    @ExcelProperty("头程运费")
    private BigDecimal cgTransportCostsTotal;
    
    @Schema(description = "其他业务成本", example = "5000.00")
    @ExcelProperty("其他业务成本")
    private BigDecimal cgOtherCostsTotal;
    
    @Schema(description = "其他业务收入", example = "10000.00")
    ...
    @Schema(description = "推广费", example = "15000.00")
    @ExcelProperty("推广费")
    private BigDecimal promotionFee;
    
    @Schema(description = "站外费", example = "8000.00")
    @ExcelProperty("站外费")
    private BigDecimal offsiteFee;
    
    @Schema(description = "其他费用", example = "12000.00")
    @ExcelProperty("其他费用")
    ...
    @Schema(description = "退款率(%)", example = "2.00")
    @ExcelProperty("退款率(%)")
