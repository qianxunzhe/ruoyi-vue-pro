 ...
 * ASIN维度聚合结果 VO
 */
@Schema(description = "管理后台 - ASIN维度聚合结果 VO")
@Data
public class ProfitReportAsinAggVO {
    
    @Schema(description = "ASIN", example = "B001234567")
    @ExcelProperty("ASIN")
    private String asin;
    
    @Schema(description = "父ASIN", example = "B001234500")
    @ExcelProperty("父ASIN")
    private String parentAsin;
    
    @Schema(description = "产品名称", example = "Product Name")
    @ExcelProperty("产品名称")
    ...
    @Schema(description = "店铺名称列表", example = "[\"US Store 1\", \"US Store 2\"]")
    @ExcelIgnore
    ...
    @Schema(description = "FBA销售数量", example = "800")
    @ExcelProperty("FBA销售数量")
    private Integer fbaSalesQuantity;
    
    @Schema(description = "FBM销售数量", example = "200")
    ...
    @Schema(description = "FBA销售金额", example = "40000.00")
    @ExcelProperty("FBA销售金额")
    private BigDecimal fbaSaleAmount;
    
    @Schema(description = "FBM销售金额", example = "10000.00")
    ...
    @Schema(description = "退货退款", example = "1000.00")
    @ExcelProperty("退货退款")
    private BigDecimal totalRefunds;
    
    @Schema(description = "销售成本", example = "3000.00")
    @ExcelProperty("销售成本")
    private BigDecimal cgPriceTotal;
    
    @Schema(description = "头程运费", example = "500.00")
    @ExcelProperty("头程运费")
    private BigDecimal cgTransportCostsTotal;
    
    @Schema(description = "其他业务成本", example = "200.00")
    @ExcelProperty("其他业务成本")
    private BigDecimal cgOtherCostsTotal;
    
    @Schema(description = "其他业务收入", example = "300.00")
    ...
    @Schema(description = "推广费", example = "500.00")
    @ExcelProperty("推广费")
    private BigDecimal promotionFee;
    
    @Schema(description = "站外费", example = "300.00")
    @ExcelProperty("站外费")
    private BigDecimal offsiteFee;
    
    @Schema(description = "其他费用", example = "400.00")
    @ExcelProperty("其他费用")
    ...
    @Schema(description = "平台费用", example = "7500.00")
    @ExcelProperty("平台费")
    private BigDecimal platformFee;
    
    @Schema(description = "FBA配送费", example = "4000.00")
    @ExcelProperty("配送费")
    private BigDecimal totalFbaDeliveryFee;
    
    @Schema(description = "仓储费用", example = "1000.00")
    @ExcelProperty("仓储费")
