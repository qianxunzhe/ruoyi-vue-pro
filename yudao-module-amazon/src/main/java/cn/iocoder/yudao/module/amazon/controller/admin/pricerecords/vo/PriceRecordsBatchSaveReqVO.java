...
@Schema(description = "管理后台 - 亚马逊产品价格记录批量保存 Request VO")
@Data
public class PriceRecordsBatchSaveReqVO {

    @Schema(description = "价格记录列表", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotEmpty(message = "价格记录列表不能为空")
    @Valid
    private List<PriceRecordItem> records;

    @Schema(description = "价格记录项")
    @Data
    public static class PriceRecordItem {
